...
public class PolicyRepositoryAdapter implements PolicyRepositoryPort {
    ...
    @Override
    public PolicyAggregate save(PolicyAggregate policy) {
    ...
    @Override
    public Optional<PolicyAggregate> findByPolicyName(String policyName) {
        return jpaRepository.findByPolicyName(policyName)
            .map(mapper::toDomain);
    }
    
    @Override
    public List<PolicyAggregate> findAll() {
    ...
    @Override
    public List<PolicyAggregate> findEnabledPolicies() {
    ...
    @Override
    public List<PolicyAggregate> findByPolicyType(PolicyType policyType) {
    ...
    @Override
    public List<PolicyAggregate> findEnabledByPolicyType(PolicyType policyType) {
