 ...
 * Note: MapStruct generates implementation at compile time, so we use Mappers factory.
 */
...
class UserDtoMapperTest {
    ...
    void toResponse_User_ShouldMapToUserResponse() {
        ...
        // Timestamps may be null if source entity doesn't have them set (using @Builder)
        // This is acceptable for mapper tests - timestamps are set by BaseEntity constructor in real usage
    }
    ...
    void toFederatedIdentityResponse_FederatedIdentity_ShouldMapToResponse() {
        ...
        assertEquals(federatedIdentity.getProviderId(), result.getProviderId());
